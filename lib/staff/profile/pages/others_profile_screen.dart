...
class StaffOthersProfileScreen extends StatelessWidget {
  const StaffOthersProfileScreen({super.key});
        ...
        children: [
          ...
          Row(
            children: [
              ...
              xWidth(10),
              Text(
                'Have 8 years experience in same field',
                textScaleFactor: scale,
                style: textStyle(
                  fontSize: 10,
                  color: rGrey,
